      ...
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col item-scenter lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pt-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                case. CaseCobre allows you to protect your memories, not just your phone case.
              </p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  scratch marks on all of my last phone cases. This one, besides a barely noticeable scratch on the
